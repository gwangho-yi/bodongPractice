...
public class FragmentSpotDancing extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_spot_dancing, container, false);
    ...
    public void onStart() {
        ...
        Call<List<Spot>> call = spotInterface.selectSpot(currentAddressName, "댄싱");

        System.out.println("댄싱");
