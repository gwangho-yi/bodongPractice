...
public class FragmentSpotDownHill extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spot_down_hill, container, false);
    ...
    public void onStart() {
        ...
        Call<List<Spot>> call = spotInterface.selectSpot(currentAddressName, "다운힐");
