...
public class FragmentSpotFreeRiding extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_spot_free_riding, container, false);
    ...
    public void onStart() {
        ...
        Call<List<Spot>> call = spotInterface.selectSpot(currentAddressName, "프리라이딩");
