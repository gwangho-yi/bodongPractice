...
public class FragmentSpotSlaom extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_spot_slaom, container, false);
    ...
    public void onStart() {
        ...
        Call<List<Spot>> call = spotInterface.selectSpot(currentAddressName, "슬라럼");
