...
public class AddReview extends AppCompatActivity {
    ...
    private void Upload(ArrayList<File> files) throws UnsupportedEncodingException {
        ...
        //스팟아이디
        RequestBody spotid = RequestBody.create(MediaType.parse("text/plain"),
                spotId);
        ...
        Call<Review> resultCall = userInterface.AddReview(spotid,rating,images,userEmail,content,number,createTime);
        resultCall.enqueue(new Callback<Review>() {
            ...
            public void onResponse(Call<Review> call, Response<Review> response) {
                ...
                Intent intent = new Intent(AddReview.this, SpotDetail.class);
